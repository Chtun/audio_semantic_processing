...
args.train_list = f"{os.getcwd()}/datasets/dataprep/{args.dataset}/train.json"
args.verify_list = f"{os.getcwd()}/datasets/dataprep/{args.dataset}/test.json"
args.label_csv = f"{os.getcwd()}/datasets/dataprep/{args.dataset}/class_labels_indices.csv"
